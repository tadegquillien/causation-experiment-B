...
const ConsentForm = (props) => {
    return (
        <div style={consentStyle}><h1>Participant Information Sheet</h1>
        ...
        Your session should last for up to STUDY_DEPENDENT minutes. You will be given full instructions shortly.</p>
